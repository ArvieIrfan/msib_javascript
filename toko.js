...
function transaksi(){
    ...
    if (produk == 'Kulkas' && jumlah >= 3) diskon = 0.3 * harga 
    else if (produk == 'AC' && jumlah >= 3) diskon = 0.2 * harga
    else diskon = 0.1 * hargaKotor

swal(`
Nama Pelanggan : ${nama}
Produk yang dibeli : ${produk}
Harga Produk : ${harga.toLocaleString()}
Jumlah Produk yang dibeli : ${jumlah}
Total yang dibayarkan : ${hargaKotor.toLocaleString()}
diskon yang didapat : ${diskon.toLocaleString()}
`)
}